...
/*! Raises the in event 'eventoFico' that is defined in the default interface scope. */ 
extern void statechart_raise_eventoFico(Statechart* handle);
/*! Gets the value of the variable 'ptr' that is defined in the default interface scope. */ 
extern void* statechart_get_ptr(const Statechart* handle);
/*! Sets the value of the variable 'ptr' that is defined in the default interface scope. */ 
extern void statechart_set_ptr(Statechart* handle, void* value);
/*! Gets the value of the variable 'value' that is defined in the default interface scope. */ 
extern int32_t statechart_get_value(const Statechart* handle);
/*! Sets the value of the variable 'value' that is defined in the default interface scope. */ 
extern void statechart_set_value(Statechart* handle, int32_t value);
